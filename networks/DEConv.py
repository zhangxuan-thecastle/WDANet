...
class Conv2d_cd(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 padding, dilation, groups, bias=False, theta=1.0):
...
class DEConv(nn.Module):
    def __init__(self, dim):
        ...
        # padding, dilation, groups, bias=True, theta=1.0)
        self.conv1_1 = Conv2d_cd(dim, dim, 3, stride=1,padding=1,dilation=1,groups=dim,bias=True)
        self.conv1_2 = Conv2d_hd(dim, dim, 3, stride=1,padding=1,dilation=1,groups=dim,bias=True)
        self.conv1_3 = Conv2d_vd(dim, dim, 3, stride=1,padding=1,dilation=1,groups=dim,bias=True)
        self.conv1_4 = Conv2d_ad(dim, dim, 3, stride=1,padding=1,dilation=1,groups=dim,bias=True)
