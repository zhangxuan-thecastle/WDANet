...
# parser.add_argument('--output_dir', type=str, help='output dir', default="./trained_ckpt-base1.1-base_lr4e-4-learn18-rate0.7-weight0.6-batchsize18-nodeform-WTConv并SSPCAB放cat前--MSCB并MFMS放concat后也放第一阶段-deform换wavelet_convs")#-up_projs并UCB上采样换
...
if __name__ == "__main__":
    ...
    summary(net, input_size=(18, 3, 224, 224))
    # print(f"net is {net}")
